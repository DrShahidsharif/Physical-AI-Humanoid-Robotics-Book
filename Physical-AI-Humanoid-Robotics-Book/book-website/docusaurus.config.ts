...
const config: Config = {
  ...
  tagline: 'A Comprehensive Guide to Modern Robotics and AI',
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Physical AI & Humanoid Robotics Book Project, Inc. Built with Docusaurus.`,
    },
    prism: {
